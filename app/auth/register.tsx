...
export default function RegisterScreen() {
  ...
  const handleComplete = async () => {
    ...
    // Flow: In production, this should call an API (e.g., PUT /auth/profile) to save the name.
    // For now, we update the local session.
    if (user) {
      await signIn({
        user: { ...user, name: name.trim(), role },
        access_token: "local-session-update", // Tokens should ideally be handled by a separate update method
        refresh_token: "local-session-update",
      });
    }
