...
const styles = StyleSheet.create({
  ...
  // ── Horizontal peek cards (snapIndex === 1) ──
  hCardScroll: { paddingHorizontal: 14, paddingBottom: 18, paddingTop: 4, gap: 12 },
  hCard: { borderRadius: 16, overflow: 'hidden', borderWidth: 1, height: 90, flexDirection: 'row', shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.06, shadowRadius: 8, elevation: 3 },
  hCardAccent: { width: 4, height: '100%' },
  hCardBody: { flex: 1, flexDirection: 'row', alignItems: 'center', paddingHorizontal: 12, paddingVertical: 10 },
  hCardLeft: { flex: 1, gap: 4 },
  hCardName: { fontSize: 14, fontWeight: '900', letterSpacing: -0.2 },
  hCardArea: { fontSize: 11 },
  hMetaRow: { flexDirection: 'row', gap: 6, marginTop: 2 },
  hMetaPill: { flexDirection: 'row', alignItems: 'center', gap: 3, paddingHorizontal: 7, paddingVertical: 3, borderRadius: 8 },
  hMetaText: { fontSize: 10, fontWeight: '700' },
  hCardRight: { alignItems: 'center', gap: 10, paddingLeft: 8 },
  hRatingBadge: { flexDirection: 'row', alignItems: 'center', gap: 3, paddingHorizontal: 6, paddingVertical: 2, borderRadius: 8 },
  hRatingText: { fontSize: 11, fontWeight: '800' },
  hStatusDot: { width: 8, height: 8, borderRadius: 4 },

  // ── Vertical full list (snapIndex === 2) ──
  vCardScroll: { paddingHorizontal: 14, paddingBottom: 20, gap: 10 },
  vCard: { flexDirection: 'row', alignItems: 'center', borderRadius: 16, borderWidth: 1, paddingHorizontal: 12, paddingVertical: 12, gap: 12, shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.05, shadowRadius: 6, elevation: 2 },
  vRank: { width: 30, height: 30, borderRadius: 10, alignItems: 'center', justifyContent: 'center' },
  vRankText: { fontSize: 11, fontWeight: '900' },
  vCardBody: { flex: 1, gap: 4 },
  vCardTop: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', gap: 8 },
  vCardName: { flex: 1, fontSize: 14, fontWeight: '900', letterSpacing: -0.2 },
  vCardArea: { fontSize: 11 },
  vMetaRow: { flexDirection: 'row', gap: 6, flexWrap: 'wrap' },

  // ── Legacy (unused but kept to avoid TS errors) ──
  cardScroll: { paddingHorizontal: 14, paddingBottom: 20, paddingTop: 4, gap: 12 },
  card: { borderRadius: 18, overflow: 'hidden', borderWidth: 1, height: 168 },
  statusStrip: { height: 3, width: '100%' },
  cardInner: { flex: 1, padding: 12, justifyContent: 'space-between' },
  cardTop: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-start', gap: 8 },
  cardName: { flex: 1, fontSize: 14, fontWeight: '900' },
