            ...
            <View style={[styles.perfCard, Shadow.xs]}>
              <View style={styles.perfRow}>
                ...
                <View style={{ flex: 1 }}>
                  ...
                  <Text style={styles.perfValue}>{(data?.rating?.avg ?? 0).toFixed(1)} <Text style={{ fontSize: 13, color: thannigoPalette.neutral }}>({data?.rating?.count})</Text></Text>
                </View>
              </View>
...
const styles = StyleSheet.create({
  ...
  periodPill: { flex: 1, paddingVertical: 10, borderRadius: 14, backgroundColor: 'white', alignItems: 'center', borderWidth: 1.5, borderColor: thannigoPalette.borderSoft },
  periodPillActive: { backgroundColor: SHOP_ACCENT, borderColor: SHOP_ACCENT },
  periodText: { fontSize: 13, fontWeight: '800', color: thannigoPalette.neutral },
  ...
  heroBadge: { backgroundColor: 'white', paddingHorizontal: 12, paddingVertical: 8, borderRadius: 12 },
  heroBadgeText: { fontSize: 12, fontWeight: '900', color: SHOP_ACCENT },

  sectionTitle: { fontSize: 18, fontWeight: '900', color: thannigoPalette.darkText, marginBottom: 16, letterSpacing: -0.5 },
  
  metricsGrid: { flexDirection: 'row', flexWrap: 'wrap', gap: 12, marginBottom: 32 },
  metricCard: {
    width: (width - 60) / 2, backgroundColor: 'white', borderRadius: 22, padding: 18,
  ...
  metricValue: { fontSize: 24, fontWeight: '900', color: thannigoPalette.darkText, marginBottom: 4 },
  metricLabel: { fontSize: 12, color: thannigoPalette.neutral, fontWeight: '700', textTransform: 'uppercase', letterSpacing: 0.5 },

  perfCard: {
    backgroundColor: 'white', borderRadius: 24, padding: 22, marginBottom: 32,
    borderWidth: 1.5, borderColor: thannigoPalette.borderSoft,
  },
  ...
  perfLabel: { fontSize: 12, color: thannigoPalette.neutral, fontWeight: '700', textTransform: 'uppercase', letterSpacing: 0.5, marginBottom: 2 },
  perfValue: { fontSize: 20, fontWeight: '900', color: thannigoPalette.darkText },
  perfDivider: { width: 1.5, height: 40, backgroundColor: thannigoPalette.borderSoft },
  ...
  perfProgressLabel: { fontSize: 13, fontWeight: '800', color: thannigoPalette.neutral },
  ...
  barLabel: { fontSize: 10, color: thannigoPalette.neutral, fontWeight: '800' },
  chartLegend: { flexDirection: 'row', gap: 20, marginTop: 18, justifyContent: 'center' },
  legendItem: { flexDirection: 'row', alignItems: 'center', gap: 8 },
  legendDot: { width: 10, height: 10, borderRadius: 5 },
  legendText: { fontSize: 12, color: thannigoPalette.neutral, fontWeight: '700' },

  listCard: {
    backgroundColor: 'white', borderRadius: 24, paddingHorizontal: 20, paddingVertical: 10, marginBottom: 40,
    borderWidth: 1.5, borderColor: thannigoPalette.borderSoft,
  },
  productRow: { flexDirection: 'row', alignItems: 'center', gap: 16, paddingVertical: 18 },
  rowDivider: { borderBottomWidth: 1.5, borderBottomColor: thannigoPalette.borderSoft },
  rankBadge: { width: 32, height: 32, borderRadius: 10, backgroundColor: thannigoPalette.background, alignItems: 'center', justifyContent: 'center', borderWidth: 1, borderColor: thannigoPalette.borderSoft },
  rankText: { fontSize: 14, fontWeight: '900', color: thannigoPalette.darkText },
  productMeta: { flexDirection: 'row', justifyContent: 'space-between', marginBottom: 8 },
  productName: { fontSize: 15, fontWeight: '800', color: thannigoPalette.darkText, flex: 1 },
  productRevenue: { fontSize: 15, fontWeight: '900', color: SHOP_ACCENT },
  progressTrack: { height: 6, backgroundColor: thannigoPalette.background, borderRadius: 3, marginBottom: 6 },
  progressFill: { height: '100%', backgroundColor: SHOP_ACCENT, borderRadius: 3 },
  productOrders: { fontSize: 12, color: thannigoPalette.neutral, fontWeight: '700' },
  barTooltip: {
    position: 'absolute', top: -30, backgroundColor: thannigoPalette.darkText,
