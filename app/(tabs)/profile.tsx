      ...
      >
        ...
        >
          ...
          <View style={styles.profileStats}>
            ...
            <View style={styles.profileStatDivider} />
            <View style={styles.profileStat}>
              <Text style={styles.profileStatVal}>₹420</Text>
              ...
              <TouchableOpacity
                ...
                onPress={() => {
                  if (item.label === 'Saved Addresses') {
                    ...
                    Alert.alert('My Reviews', 'You have written 3 reviews. Review management coming soon!');
                  } else if (item.label === 'Privacy & Security') {
                    Alert.alert('Privacy & Security', 'Your data is encrypted and stored securely. No data is sold to third parties.\n\nFor data requests contact: privacy@thannigo.com');
                    ...
                    Alert.alert(
                      ...
                      [
                        ...
                        { text: 'Call Us', onPress: () => Linking.openURL('tel:+918000000000') },
                      ]
                    );
                  } else if (item.label === 'About ThanniGo') {
                    Alert.alert('ThanniGo', 'Version 1.0.0\n\nIndia\'s fastest 15-minute water delivery platform.\n\n© 2026 ThanniGo Pvt. Ltd.');
                  }
                }}
              >
...
const styles = StyleSheet.create({
  ...
  profileCard: {
    borderRadius: 28, padding: 28, marginTop: 20, marginBottom: 14,
    alignItems: 'center', overflow: 'hidden', position: 'relative',
    shadowColor: '#005d90', shadowOffset: { width: 0, height: 8 }, shadowOpacity: 0.3, shadowRadius: 20, elevation: 8,
  },
  ...
  editAvatarBtn: {
    ...
    backgroundColor: '#006878', alignItems: 'center', justifyContent: 'center',
  ...
  editProfileBtn: {
    ...
    backgroundColor: 'white', borderRadius: 16, paddingVertical: 12,
    borderWidth: 1.5, borderColor: '#e0f0ff',
    marginBottom: 16,
  ...
  memberBadge: {
    ...
    backgroundColor: '#e0f0ff', borderRadius: 20, padding: 16, marginBottom: 24,
    borderWidth: 1.5, borderColor: '#b3d9f2',
  },
  memberBadgeIcon: {
  ...
  logoutBtn: {
    flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8,
    backgroundColor: '#ffdad6', borderRadius: 16, paddingVertical: 14,
    marginBottom: 20,
  },
