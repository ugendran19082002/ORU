...
const styles = StyleSheet.create({
  ...
  successTitle: { fontSize: 24, fontWeight: '900', color: thannigoPalette.darkText, textAlign: 'center', marginBottom: 8 },
  successSub: { fontSize: 14, color: thannigoPalette.neutral, textAlign: 'center', paddingHorizontal: 20, lineHeight: 20, marginBottom: 40 },
  ...
  ratingLabel: { fontSize: 16, fontWeight: '800', color: thannigoPalette.darkText, marginBottom: 16 },
  starsRow: { flexDirection: 'row', gap: 12 },

  feedbackWrap: { marginTop: 10 },
  feedbackLabel: { fontSize: 14, fontWeight: '800', color: thannigoPalette.darkText, marginBottom: 10, marginLeft: 4 },
  feedbackInput: { backgroundColor: 'white', borderRadius: 20, padding: 20, height: 120, fontSize: 15, color: thannigoPalette.darkText, borderWidth: 1, borderColor: thannigoPalette.borderSoft, shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.02, shadowRadius: 4, elevation: 1 },
